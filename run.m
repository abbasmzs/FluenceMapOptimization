...
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
addpath('E:\Industrial visiting\Behyar_Sanat\Papers that is refered to two PhD students\FluenceMapOpt-master\minConf\minConf');
addpath('E:\Industrial visiting\Behyar_Sanat\Papers that is refered to two PhD students\FluenceMapOpt-master\minConf\minConf\minConf');
addpath('E:\Industrial visiting\Behyar_Sanat\Papers that is refered to two PhD students\FluenceMapOpt-master\minConf\minConf\minFunc');
